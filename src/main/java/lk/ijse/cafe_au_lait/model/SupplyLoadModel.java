...
//    public static boolean PlaceSupplyLoad(String supId, String supLoadId, String payment, List<SupplyLoadDTO> data) throws SQLException {
//        Connection con = null;
//        try {
...
//    }
//
//    private static boolean saveSupplyLoad(String supLoadId, String supId, String payment, LocalDate now, LocalTime now1, List<SupplyLoadDTO> data) throws SQLException {
//        for (SupplyLoadDTO supplyLoadDTO : data) {
//            if (!saveSupplyLoad(supLoadId, supId, payment, now, now1, supplyLoadDTO)) {
//                return false;
//            }
//        }
//        return true;
...
//    }
//
//    private static boolean saveSupplyLoad(String supLoadId, String supId, String payment, LocalDate now, LocalTime now1, SupplyLoadDTO supplyLoadDTO) throws SQLException {
...
//                supLoadId,
//                supplyLoadDTO.getItemId(),
//                supId,
//                supplyLoadDTO.getQty(), now1,
//                now, payment);
//
//    }
}
